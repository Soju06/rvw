/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 25b21efff619b1250c2d31d0ddd35c7b)
// Runtime types generated with workerd@1.20260831.1 2026-09-02 nodejs_compat
interface __BaseEnv_Env {
	RVW_ARTIFACTS: R2Bucket;
	RVW_REVIEW_JOBS: Queue;
	RVW_REVIEW_JOBS_DLQ: Queue;
	RVW_ENV: "spike" | "prod" | "dev";
	RVW_VERSION: "0.0.0";
	RVW_JOB_DEADLINE_MINUTES: "120";
	RVW_REVIEW_DEADLINE_SECONDS: "900";
	RVW_SANDBOX: DurableObjectNamespace<import("./worker/src/index").RvwSandbox>;
	RVW_REVIEW_JOB: DurableObjectNamespace<import("./worker/src/index").RvwReviewJob>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/src/index");
		durableNamespaces: "RvwSandbox" | "RvwReviewJob";
	}
	interface SpikeEnv {
		RVW_ARTIFACTS: R2Bucket;
		RVW_REVIEW_JOBS: Queue;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RVW_ENV" | "RVW_VERSION" | "RVW_JOB_DEADLINE_MINUTES" | "RVW_REVIEW_DEADLINE_SECONDS">> {}
}
