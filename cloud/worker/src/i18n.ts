...
export const catalogEn = {
  ...
  check_skipped: "{short_name} · Review skipped",
  trigger_skipped: "Review skipped by repository policy: {rule}.",
  trigger_no_match: "no matching allowlist rule",
  events_disabled: "automatic pull request reviews are disabled",
  action_not_selected: "this pull request action is not selected",
  same_head_reviewed: "this exact commit was already reviewed",
  in_flight_same_head: "this exact commit is already being reviewed",
  job: "Job {job_id}",
...
export const catalogKo: Record<MessageKey, string> = {
  ...
  check_skipped: "{short_name} · 검토 건너뜀",
  trigger_skipped: "저장소 정책에 따라 검토를 건너뛰었습니다: {rule}.",
  trigger_no_match: "일치하는 허용 목록 규칙 없음",
  events_disabled: "자동 풀 리퀘스트 검토가 비활성화됨",
  action_not_selected: "이 풀 리퀘스트 작업은 선택되지 않음",
  same_head_reviewed: "이 커밋은 이미 검토됨",
  in_flight_same_head: "이 커밋을 이미 검토 중",
  job: "작업 {job_id}",
